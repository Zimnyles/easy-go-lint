...
This bundled binary is built for `darwin-arm64` with `go1.27rc2` from the
official Go 1.27 compatibility pull request #6642 at commit
`c4815f06852754c8daa088b684d71fd88589b175`. Its reported version is
